...
const Item:React.FC<ItemProps> = ({title,paragraph,grid,img}) => {
  return (
    <div className={`automated-item ${grid} p-[2px] rounded-lg bg-[linear-gradient(45deg,black,gray)]`}>
        <div className="automated-item-inner flex justify-center items-center flex-col h-[400px] py-2 px bg-neutral-950/90 rounded-lg">
