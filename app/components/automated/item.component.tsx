...
const Item:React.FC<ItemProps> = ({title,paragraph,grid,img}) => {
  return (
    <div className={`automated-item md:w-[640px] ${grid} my-2 lg:my-0 p-[2px] rounded-lg bg-[linear-gradient(45deg,black,gray)]`}>
        <div className="automated-item-inner flex justify-center items-center flex-col h-[400px] py-2 bg-neutral-950/90 rounded-lg">
            {title && <h3 className="md:w-2/3 my-2 text-2xl md:text-3xl text-center font-bold">{title}</h3>}
