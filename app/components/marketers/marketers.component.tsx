...
const Marketers = () => {
  return (
    ...
    <Background>
      <div className="marketers mb-12 lg:h-[700px] relative top-0 left-0">
        ...
        <div className="marketers-row-1 lg:absolute lg:top-24 lg:left-0 lg:flex lg:justify-start lg:items-start">
          ...
          <Count className='lg:w-2/4 lg:min-h-[250px] xl:min-h-[210px]' title='Words that rank on Google thanks to Satellitor' count={10.680000} />
        ...
        <div className="marketers-row-1 lg:absolute lg:top-[360px] xl:top-[320px] lg:left-1/4  lg:flex lg:justify-start lg:items-start">
