...
const Feature = () => {
  ...
  const handleAnimateConnect = () =>{
    ...
    if((typeof window !== 'undefined')){
      if(typeof document !== 'undefined'){
        const path_1 = document.querySelector('.publish-feature-connect-left path') as SVGPathElement
        const path_2 = document.querySelector('.publish-feature-connect-right path')  as SVGPathElement
        const path_1_dash = path_1.getTotalLength()
        const path_2_dash = path_2.getTotalLength()
        path_1.style.strokeDasharray = String(path_1_dash)
        path_2.style.strokeDasharray = String(path_2_dash)
        path_1.style.strokeDashoffset = String(path_1_dash)
        path_2.style.strokeDashoffset = String(path_2_dash)
  ...
  const handleAnimateMainPath = () =>{
    ...
    if((typeof window !== 'undefined')){
      if(typeof document !== 'undefined'){
        const path_1 = document.querySelector('.publish-feature-main-path path') as SVGPathElement
        const path_1_dash = path_1.getTotalLength()
        path_1.style.strokeDasharray = String(path_1_dash)
        path_1.style.strokeDashoffset = String(path_1_dash)
        gsap.fromTo(path_1,{strokeDashoffset:path_1_dash},{ strokeDashoffset:0,duration:20,scrollTrigger:{
  ...
  return (
    <div className='publish-feature relative top-0 md:px-12 lg:px-0 md:-mt-11 left-0 xl:w-100 lg:ml-12 h-[430px] xl:h-[435px]'>
        
      <div className='publish-feature-connect relative top-12 -left-12'>
      ...
      <div className='publish-feature-main-content relative top-12 -left-5'>
        ...
        <div className="publish-feature-connect flex bg-neutral-900 rounded-lg border-[1px] border-gray-800 relative z-10 top-8 left-24  py-2 px-10 w-fit">
